This sample code is based on the main example in the XML DOM tutorial here:
http://w3schools.com/xml/xml_dom.asp

This code uses the synchronous form of the XMLHttp request by setting the third parameter
async=false in the open() method of the XMLHttpRequest object. Contrast this with the
basic AJAX example which uses the asynchronous form.
